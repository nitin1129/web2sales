...
const AlertDialogAction = React.forwardRef(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-center rounded-md bg-[#6255A4] px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-[#6255A4]/90 focus:outline-none focus:ring-2 focus:ring-[#6255A4] focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50',
      className
    )}
    {...props}
  />
